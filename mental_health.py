...
"Remain Constant"])
        ...
        with col8:
            tv_time = st.number_input('Time spent on TV',min_value=0, max_value=0.6,step=0.1,key="b")
        with col9:
            social_media_time = st.number_input('Time spent on social media',min_value=0, max_value=0.6,step=0.1,key="c")
        with col10:
